...
function Listbusinessdetails({user}) {
  const { postId, name, phone, email, ownerId} = useParams();
                                                ...
                                                <div class="row">
                                                                ...
                                                                <div class="row more-info" >
                                                                        <div class=" col-md-6 col-sm-6 col-xs-12">
                                                                                ...
                                                                                <span class="streetAddress" itemprop="streetAddress"> 
                                                                                                        ...
                                                                                                        <a class="link" style={{color: "#000"}} href="#" title="Car Hire in Gitanga Rd, Nairobi">{post?.address}, {post?.location}
                                                                                                        </a> 
                                                                                                </span>
                                                                         </div>
                                                                        ...
                                                                        <div class=" col-md-6 col-sm-6 col-xs-12">
                                                                                <div class="info-full services products">
                                                                                        <h2>Category</h2>
                                                                                        <p><a>{post?.industry}</a></p>
                                                                                </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                                                <div class="info-full services brands ">
                                                                                        <h2>Activity</h2>
                                                                                        <p><a>{post?.descriptions}</a></p>
                                                                                </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                        ...
                                                        <div class="col-md-4 col-sm-4 col-xs-12 knowledge-graph map-area">
                                                                ...
                                                                <div class="suggest-edit"> 
                                                                        <Link to={`/businesses-email/${postId}/${name}/${phone}/${email}/${ownerId}/${post?.businessName}/${post?.industry}`} class="btn btn-lg btn-primary" title="Send an email message to Wairimu Car Hire">Send Message To {name}
                                                                        </Link>
                                                                </div>
