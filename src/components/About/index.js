                                          ...
                                          <div class="field field-name-body field-type-text-with-summary field-label-hidden">
                                            <div class="field-items">
                                              <div class="field-item even" property="content:encoded">
                                                ...
                                                <ul>
                                                  <li>
                                                    <strong>Print Directories</strong><br />Every year, we publish the Nairobi, Coast and Inland editions of the Kenya Telephone Directory, the National Business and Yellow Pages Directory for business and general users, and the Travel Discover Kenya for the tourism industry.
                                                  </li>
                                                    <li>
