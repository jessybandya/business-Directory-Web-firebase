...
function Home({user}) {
  ...
  const updateSearchResults = (e) => {
        ...
        <a style={{display: "none"}} href="#yellowmobile" class="skip-link visually-hidden visually-hidden--focusable" id="skip-link">Jump to navigation</a>
          ...
          <header  class="header">
                   ...
                   <section class="hero-image"><div class="hero-image-slide">
                                ...
                                </div><div class="col-md-10 col-sm-10 col-xs-10 searching-form">
                                    <form class="search-form search-yellowpageskenya" method="GET" action="">
                                        <div class="form-row">
                                            <div class="col-md-5 col-sm-5 col-xs-12"> 
                                                ...
                                                <input type="text" class="form-control" name="what" id="lookingfor" onClick={()=> alert("kindly login first")}  placeholder="I am Looking For ...."/>
                                        ...
                                        <div class="col-md-5 col-sm-5 col-xs-12"> 
                                            ...
                                            <div class="input-group mb-2">
                                                <div class="input-group-prepend">
                                                    ...
                                                    </div></div> <input type="text" class="form-control" name="where" id="location" onClick={()=> alert("kindly login first")} placeholder="Location"/>
                                                </div>
                                            </div>
    ...
    <div class="container view-content">
        <div class="row"><div class="col-md-2 col-sm-6 col-xs-12 category">
            ...
            <div class="view-header">
                    ...
                    <div class="row">
                        ...
                        <div class="learn-how-cta"> 
                            <a href="/register-business" class="btn btn-lg btn-outline-primary" title="Advertise with us ... be part of yellow pages">Learn How<span><i class="fas fa-arrow-right"></i></span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container"><div class="row">
                ...
                <div class="col-md-5 col-sm-5 col-xs-12 digital-content">
                    ...
                    <div class="agency-cta"> 
                        <a href="register-business" class="btn btn-lg btn-outline-primary" title="Advertise with us ... be part of yellow pages">Advertise with Us<span><i class="fas fa-arrow-right"></i></span>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12 app-content">
                        <h2>Take YP with you</h2>
                        <p>With the YP app, you can find millions of local businesses on the go and quickly connect with them from anywhere. It's free!</p> 
                        <a rel="noopener noreferrer" arial-label="Download Yellow Pages App On Google Playstore Store" href="https://play.google.com/store/apps/details?id=com.yellowpages.appke" target="_blank">
                            <span><i class="fab fa-google-play"></i></span>Download On Google Play
                        </a> 
                        <a rel="noopener noreferrer" arial-label="Download Yellow Pages App On Apple Store" href="https://apps.apple.com/ke/app/postel-yellow-pages/id916150441" target="_blank">
        ...
        <section class="partners-logo">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-xs-3 partner-logo"> 
                        <a target="_blank" href="https://www.monosolutions.com/" title="Yellow Pages Drive online success for SMBs" rel="noopener noreferrer" > 
                            <img class="lazyload" data-src='/sites/all/themes/yp/images/partners/mono.jpg' alt="MONO: Yellow Pages Drive online success for SMBs" width="200" height="200" src="https://yellowpageskenya.com/sites/all/themes/yp/images/partners/mono.jpg"/> 
                        </a>
                    </div>
                    <div class="col-md-3 col-sm-3 col-xs-3 partner-logo"> 
        ...
        <CSSTransition
          ...
          <div style={{height: 250}} className="menu">
            ...
            <DropdownItem style={{marginTop: 15}} leftIcon={<BusinessCenterSharpIcon />}>
                <a href="/login-client">
                  <p style={{marginTop:0}}>My Profile</p>
                  </a>
                  </DropdownItem>
            <DropdownItem style={{marginTop: 15}} leftIcon={<BusinessCenterSharpIcon />}>
                <a href="/list-businesses">
                  <p style={{marginTop:0}}>Business Profiles (Lists)</p>
                  </a>
                  </DropdownItem>
          </div>
        </CSSTransition>
        <CSSTransition
          ...
          <div style={{height: 250}} className="menu">
            ...
            <Link to="/register-client">
                  <p style={{marginTop:0}}>Register as client</p>
                  </Link>
            </DropdownItem>

            <DropdownItem style={{marginTop: 15}} leftIcon={<BusinessCenterSharpIcon />}>
                <Link to="/register-business">
                  <p style={{marginTop:0}}>Register business</p>
                  </Link>
                  </DropdownItem>
          </div>
        </CSSTransition>
