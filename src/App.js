    ...
    <Router>
      ...
      <Route exact path="/">
         ...
         <Route exact path="/list-clients" component={Listclients}/>
                 ...
                 <Route exact path="/list-businesses-details/:postId/:name/:phone/:email/:ownerId">
              <Listbusinessdetails  user={user}/>
            </Route> 
         <Route exact path="/businesses-email/:postId/:name/:phone/:email/:ownerId/:businessName/:category">
